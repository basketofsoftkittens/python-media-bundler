...
DEFER_JAVASCRIPT = getattr(settings, "DEFER_JAVASCRIPT", default_settings.DEFER_JAVASCRIPT)

MEDIA_BUNDLES = getattr(settings, "MEDIA_BUNDLES", default_settings.MEDIA_BUNDLES)
